...
Please note the folder name will be relevent to your own path.
...
```{r Data visualisation/Quality control, eval=FALSE}
...
``` {r Perform Filtering, Normalisation, Regression and variable gene assessment, eval=FALSE }
...
![An elbow plot can identify which principal components must be retained to capture most of the information](/Users/craigmcdougall/Documents/Project 2/Data Analysis Reporting/elbow.png){width=50%}
...
``` {r Perform princial component analysis and dimensional reduction (UMAP), eval=FALSE }
#PCA to identify PCs
...
```{r Perform clustering, eval=FALSE}
...
![Dimensional reuction plot allows visualisation of the clusters found found in the UMAP data](/Users/craigmcdougall/Documents/Project 2/Data Analysis Reporting/clusters.png){width=50%}
