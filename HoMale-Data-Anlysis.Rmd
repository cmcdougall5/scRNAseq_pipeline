...
The QC plots to inform which cells should be excluded on quality basis (low quality, double counts). All cells below 200 counts are dropped and cells with >5% mitochondrial DNA are also dropped. 
