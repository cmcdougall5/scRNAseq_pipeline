...
#list all the files in the data directory, to make sure this is where we expect to be
list.files(data.dir)
...
#PCA to identify PCs
cortico <- RunPCA(cortico,verbose= FALSE, approx=FALSE) 
...
This analysis based on 14 of 30 possible principal components suggests cluster 6 to be the corticotrophs. Differential expression analysis showed the top differentially expressed gene found in 81% of corticodroh cells (and 1% of all other cells) was Rpl10l.
