...
canonical <- c("Gh1","Prl","Cga","Tshb","Pomc", "Pcsk2","Crhr1")
...
#Feature plot
FeaturePlot(data, features = canonical)&scale_color_viridis_c()
...
new.cluster.ids <- c("Stem Cells","Somatotroph","Stem cells","Corticotroph","Stem cells","WBC","Somatotroph","Lactotroph","Somatotroph","Gonadotroph","Endothelial cells","Uncategorised","Thyrotroph","Uncategorised","Collagen")
...
saveRDS(data, file = "NamedClusters.rds")
